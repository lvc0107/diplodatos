...
Utilizar la matriz de covarianza de un conjunto de datos para encontrar una transformacion a nuevas variables que no estan correlacionadas es llamado:
...
y  $\pi_{k} = 1/K$ estan fijos,  por lo que solamente los centros de los cumulos, $\mu_{k} \in \mathbb{R}^{D}$, tienen que ser estimados.
...
Elejimos trabjar con el mismo dataset del practico 1 : Flights.Mostramos clusters plotendo 2 features: dep_delay, arr_delay.
